...
class INA219
{
    public:
        /**
         * @brief If nothing is known, set the default as using DFRobot_INA219
         * 
         * @param shunt_resistance = 0.01 Shunt resistance in Ohms.
         * @param max_expected_amps = 8 Maximum expected current in Amps.
         */
        INA219();
        /**
    ...
    private:
        ...
        float   _current_lsb;
        float   _power_lsb;
	int 	calValue = 4096; //default calibration value, needed to be calibrated in the constructor based on the current measured by the outer equipments (multimeter) and powermeter
    // Public functions
    public:
        /**
