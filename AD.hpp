...
private:
float AIN_DATA[4] = {0,0,0,0};
float AIN_DATA_BUFFER[4] = {0,0,0,0};
public:
    /***************************************************************************
    *  @brief: Construction function. Initialise the AD 
    ***************************************************************************/
 	AD();
	
    /***************************************************************************
    *  @brief: Read the AD from I2C port
    ***************************************************************************/
	uint16_t 	I2C_readU16(char reg);
	
	/***************************************************************************
    *  @brief: Write the configuration to I2C, to determinate which channel to read
    ***************************************************************************/
	void 		I2C_writeWord(char reg, uint16_t val);
	
    /***************************************************************************
    *  @brief: Initialise the AD 
    ***************************************************************************/	
	uint16_t 	ADS1015_INIT();
	
    /***************************************************************************
    *  @brief: Read a single channel of AD input through I2C
    ***************************************************************************/
	uint16_t 	ADS1015_SINGLE_READ(uint8_t channel);
	
    /***************************************************************************
    *  @brief: Read AD input through I2C and refresh the stored data
    ***************************************************************************/	
	int 		refreshADInputs();
    ...
    *  @brief: Read a single channel of AD input through I2C
    ***************************************************************************/	
	float 		getADInputs(int ADChannel);
};
